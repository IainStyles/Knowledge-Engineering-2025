...
3. Are the following arguments valid, sound, neither, or both? Assume that statements (i) and (ii) are the premises of the argument, and statement (iii) is the conclusion.
    a)
...
a) This is sound because the premises are true, but is not valid because the conclusion does not follow from the premises.  
...
c) This is sound (both premises are true) but it is not valid because the premises do not preclude the sun not being visible during the daytime (because of cloud, for example).  
